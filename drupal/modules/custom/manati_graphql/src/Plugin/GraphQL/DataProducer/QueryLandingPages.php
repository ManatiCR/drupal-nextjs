 ...
 * )
 */
class QueryLandingPages extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function resolve($offset, $limit, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query->condition($entityType->getKey('bundle'), 'landing_page');
